...
1. Edit the [main application to execute in the example project](https://github.com/zio/zio-http/blob/main/project/Debug.scala) - modify `className` to the example you'd like to run.
2. From sbt shell, run `project example` -> `~reStart`. You should see `Server started on port: 8080`.
